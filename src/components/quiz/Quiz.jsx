...
const Quiz = () => {
  ...
  const getUserQuiz = async () => {
    try {
      setLoading(true);
      let quizCategory =
        category === "General-Knowledge" ? "General Knowledge" : category;
      const res = await userQuiz({
  ...
  const handleNext = () => {
    ...
    if (selectedValue) {
      setScore((prevScore) =>
        quiz.quiz[quesCount].correct_answer === selectedValue
          ? prevScore + 4
          : prevScore - 1
      );
    }
  ...
  const submitQuiz = async (finalScore) => {
    try {
      ...
      setLoading(false);
      history.push(
        `/score?category=${category}&difficulty=${diffculty}&score=${finalScore}`
      );
    } catch (error) {
      setLoading(false);
    }
          ...
          >
            ...
            >
              <FormControlLabel
                ...
                onChange={() => {
                  handleChange(`${quiz.quiz[quesCount].options[0]}`);
                }}
            ...
            >
              <FormControlLabel
                ...
                onChange={() => {
                  handleChange(`${quiz.quiz[quesCount].options[1]}`);
                }}
            ...
            >
              <FormControlLabel
                ...
                onChange={() => {
                  handleChange(`${quiz.quiz[quesCount].options[2]}`);
                }}
            ...
            >
              <FormControlLabel
                ...
                onChange={() => {
                  handleChange(`${quiz.quiz[quesCount].options[3]}`);
                }}
