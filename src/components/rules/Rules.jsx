    ...
    <Box sx={style.rulesContainer}>
      <Paper sx={style.paper} eleveation={5}>
        ...
        <Box sx={{ marginBottom: "0.8rem" }}>
          1. For every right answer 4 marks will be awarded.
        </Box>
        <Box sx={{ marginBottom: "0.8rem" }}>
          2. For every wrong answer 1 mark will be deducted.
        </Box>
        <Box sx={{ marginBottom: "0.8rem" }}>
          3. Select the level of diffculty from below.
        </Box>
        <Box sx={{ display: "flex", justifyContent: "space-around" }}>
          <Chip
            color="primary"
            label="Easy"
            variant={diffculty === "easy" ? "filled" : "outlined"}
            onClick={() => {
          ...
          <Chip
            color="secondary"
            label="Medium"
            variant={diffculty === "medium" ? "filled" : "outlined"}
            onClick={() => {
              selectDiffculty("medium");
            }}
          />
          <Chip
            color="warning"
            label="Diffcult"
            variant={diffculty === "hard" ? "filled" : "outlined"}
            onClick={() => {
              selectDiffculty("hard");
            }}
          />
        </Box>
